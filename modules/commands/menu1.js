...
module.exports.handleReply = async function ({ api, event, handleReply }) {
	...
	const img = ["https://i.imgur.com/WRatlod.mp4",
              "https://i.imgur.com/yHCMRqB.mp4"]
...
module.exports.run = async function({ api, event, args }) {
	...
	if (args[0] && ["all", "-a"].includes(args[0].trim())) {
      ...
      msg += `\n『🗃』𝑩𝒂̣𝒏 𝒄𝒐́ 𝒕𝒉𝒆̂̉ 𝒅𝒖̀𝒏𝒈 ${prefix}𝒉𝒆𝒍𝒑 𝒂𝒍𝒍 𝒅𝒆̂̉ 𝒙𝒆𝒎 𝒕𝒂̂́𝒕 𝒄𝒂̉ 𝒍𝒆̣̂𝒏𝒉\𝒏\𝒏╭───000───╮\n
.\n╰───𝑳𝒆̣̂𝒏𝒉───╯\𝒏『✏』𝑹𝑬𝑷𝑳𝒀 𝒕𝒊𝒏 𝒏𝒉𝒂̆́𝒏 𝒕𝒉𝒆𝒐 𝒔𝒐̂́ đ𝒆̂̉ 𝒙𝒆𝒎 𝒕𝒉𝒐̂𝒏𝒈 𝒕𝒊𝒏 𝒄𝒉𝒊 𝒕𝒊𝒆̂́𝒕 𝒍𝒆̣̂𝒏𝒉 𝒗𝒂̀ 𝒄𝒂́𝒄𝒉 𝒔𝒖̛̉ 𝒅𝒖̣𝒏𝒈 𝒍𝒆̣̂𝒏𝒉\n `
    ...
    msg += `\n『📝』𝑩𝒂̣𝒏 𝒄𝒐́ 𝒕𝒉𝒆̂̉ 𝒅𝒖̀𝒏𝒈 ${prefix}𝒎𝒆𝒏𝒖 𝒂𝒍𝒍 𝒅𝒆̂̉ 𝒙𝒆𝒎 𝒕𝒂̂́𝒕 𝒄𝒂̉ 𝒍𝒆̣̂𝒏𝒉`
		msg += `\n╭─────╮\n    𝐲𝐨𝐭𝐚𝐳𝐨     \n╰─────╯ \n	『✏』𝑹𝑬𝑷𝑳𝒀 𝒕𝒊𝒏 𝒏𝒉𝒂̆́𝒏 𝒕𝒉𝒆𝒐 𝒔𝒐̂́ 𝒅𝒆̂̉ 𝒙𝒆𝒎 𝒄𝒂́𝒄 𝒍𝒆̣̂𝒏𝒉 𝒕𝒉𝒆𝒐 𝒑𝒉𝒂̂𝒏 𝒍𝒐𝒂̣𝒊 𝑩𝑶𝑻 𝐧𝐲𝐚𝐧𝐤𝐨`;
	}
	var msgg = {body: msg, attachment: imgP}
