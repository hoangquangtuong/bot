...
module.exports.onLoad = () => {
  ...
  if (!fs.existsSync(dirMaterial + "demngayyeu.mp4")) request("https://i.imgur.com/Y7h8Qap.mp4").pipe(fs.createWriteStream(dirMaterial + "demngayyeu.mp4"));
}
...
module.exports.handleEvent = async ({ event, api, Users }) => {
  ...
  var msg = {
    body: `[❤️] Đ𝑬̂́𝑴 𝑵𝑮𝑨̀𝒀 𝒀𝑬̂𝑼 𝑪𝑼̉𝑨 𝑨𝑫𝑴𝑰𝑵 [❤️]\n\n◆━━━━━━━━━━━━━━━━◆\n\n[💟] 𝑰 𝑳𝒐𝒗𝒆 𝒀𝒐𝒖 [💟]\n[💓]→ 𝑳𝒐̛̀𝒊 𝒄𝒉𝒖́𝒄: ${chuc}\n\n[😘]→ 𝑻𝒉𝒐̛̀𝒊 𝒈𝒊𝒂𝒏 𝒃𝒆̂𝒏 𝒏𝒉𝒂𝒖: ${parseDays} 𝒏𝒈𝒂̀𝒚 : ${parseHours} : 𝒕𝒊𝒆̂́𝒏𝒈 ${parseMinutes} : 𝒑𝒉𝒖́𝒕 ${parseSeconds} 𝒈𝒊𝒂̂𝒚`, attachment: fs.createReadStream(__dirname + `/Noprefix/demngayyeu.mp4`)
  }
  // Gọi bot
