...
module.exports.handleReply = async function ({
    ...
    handleReply
      ...
      if ( answerUser == answer ) {
        ...
        return api.sendMessage(`[⚜️]→ Chính xác, đáp án là: ${answer}`, event.threadID, event.messageID)
      }
      else 
        api.unsendMessage(messageID)
        return api.sendMessage(`[⚜️]→ Opps sai rồi, đáp án là: ${answer}`, event.threadID, event.messageID)
}