...
module.exports.run = async function ({ api, event, args, Users, Currencies }) {
    ...
    switch (input) {
        case '1': {
            ...
            if (author.status == true) return api.sendMessage(`[⚜️]→ 𝐌𝐮𝐨̂́𝐧 𝐜𝐚̆́𝐦 𝐬𝐮̛̀𝐧𝐠 𝐧𝐠𝐮̛𝐨̛̀𝐢 𝐭𝐚 𝐡𝐚𝐲 𝐬𝐚𝐨 ?, 𝐡𝐚̃𝐲 𝐥𝐚̀𝐦 𝐦𝐨̣̂𝐭 𝐜𝐨𝐧 𝐧𝐠𝐮̛𝐨̛̀𝐢 𝐜𝐨́ 𝐭𝐫𝐚́𝐜𝐡 𝐧𝐡𝐢𝐞̣̂𝐦 𝐧𝐚̀𝐨. 𝐁𝐚̣𝐧 𝐡𝐢𝐞̣̂𝐧 𝐨̛̉ 𝐭𝐫𝐚̣𝐧𝐠 𝐭𝐡𝐚́𝐢 𝐃𝐚𝐭𝐢𝐧𝐠 𝐫𝐨̂̀𝐢 𝐜𝐨̀𝐧 𝐦𝐮𝐨̂́𝐧 𝐤𝐢𝐞̂́𝐦 𝐭𝐡𝐞̂𝐦 𝐧𝐠𝐮̛𝐨̛̀𝐢 𝐤𝐡𝐚́𝐜 𝐚̀ 😈`, threadID, messageID);
            break;
        }
        case '2': {
            if (author == undefined) break
        ...
        case '3': {
            if (author == undefined || author.status == false) return api.sendMessage(`[⚜️]→ 𝐁𝐚̣𝐧 𝐜𝐡𝐮̛𝐚 𝐡𝐞̣𝐧 𝐡𝐨̀ 𝐯𝐨̛́𝐢 𝐚𝐢 𝐭𝐡𝐢̀ 𝐜𝐡𝐢𝐚 𝐭𝐚𝐲 𝐜𝐚́𝐢 𝐠𝐢̀ ?`, threadID, messageID);
        ...
        case '5': {
            if (author == undefined || author.status == false) return api.sendMessage(`[⚜️]→ 𝐁𝐚̣𝐧 𝐅.𝐀 𝐬𝐦𝐥 𝐫𝐚 𝐦𝐚̀ 𝗺𝘂𝗮 𝐜𝐚́𝐢 𝐠𝐢̀ 𝐳𝐚̣̂𝐲 𝐡𝐮̛̉ ?`, threadID, messageID);
            var shop = [
        ...
        case '6': {
            if (author == undefined || author.status == false) return api.sendMessage(`[⚜️]→ 𝐅𝐀 𝐦𝐚̀ 𝐝𝐢𝐞𝐦𝐝𝐚𝐧𝐡 𝐜𝐚́𝐢 𝐠𝐢̀ 𝐜𝐨̛ ?`, threadID, messageID);
            if (author.data.daily != null && Date.now() - author.data.daily < 86400000)
                return api.sendMessage(`[⚜️]→ 𝐇𝐨̂𝐦 𝐧𝐚𝐲 𝐜𝐚̉ 𝟐 𝐛𝐚̣𝐧 𝐝𝐢𝐞𝐦𝐝𝐚𝐧𝐡 𝐫𝐨̂̀𝐢 𝐡𝐚̃𝐲 𝐪𝐮𝐚𝐲 𝐥𝐚̣𝐢 𝐬𝐚𝐮 𝟐𝟒 𝐭𝐢𝐞̂́𝐧𝐠 𝐧𝐮̛̃𝐚 𝐧𝐡𝐞́`, threadID, messageID)
            return api.sendMessage(`[⚜️]→ 𝐂𝐚̉ 𝟐 𝐜𝐮̀𝐧𝐠 𝐭𝐡𝐚̉ 𝐜𝐚̉𝐦 𝐱𝐮́𝐜 [❤] 𝐯𝐚̀𝐨 𝐭𝐢𝐧 𝐧𝐡𝐚̆́𝐧 𝐧𝐚̀𝐲 𝐯𝐚̀ 𝐜𝐮̀𝐧𝐠 𝐝𝐢𝐞𝐦𝐝𝐚𝐧𝐡 !`, threadID, (error, info) => {
                global.client.handleReaction.push({
                    name: this.config.name,
                    type: input,
                    messageID: info.messageID,
        ...
        case '7': {
            if (dataDating.length == 0) return api.sendMessage('[⚜️]→ 𝐂𝐡𝐮̛𝐚 𝐜𝐨́ 𝐜𝐚̣̆𝐩 𝐧𝐚̀𝐨 𝐭𝐫𝐨𝐧𝐠 𝐝𝐮̛̃ 𝐥𝐢𝐞̣̂𝐮 𝐜𝐮̉𝐚 𝐛𝐨𝐭', threadID, messageID);
        ...
        case '10': {
            ...
            var msg = `[⚜️]→ 𝐁𝐚̣𝐧 𝐡𝐢𝐞̣̂𝐧 𝐜𝐨́ ${authorPoint} 𝐩𝐨𝐢𝐧𝐭, 𝐫𝐞𝐩𝐥𝐲 𝐬𝐨̂́ 𝐩𝐨𝐢𝐧𝐭 𝐛𝐚̣𝐧 𝐦𝐮𝐨̂́𝐧 𝐭𝐡𝐚̀𝐧𝐡 𝐭𝐢𝐞̂̀𝐧 𝐦𝐚̣̆𝐭 💵`;
            return api.sendMessage(msg, threadID, (err, info) => {
                global.client.handleReply.push({
                    name: this.config.name,
                    type: 'convertToMoney',
    ...
    return api.sendMessage(`[⚜️]→ 𝐁𝐚̣𝐧 𝐬𝐞̃ 𝐛𝐢̣ 𝐭𝐫𝐮̛̀ 1.380.000.000 𝐕𝐍𝐃 𝐭𝐢𝐞̂̀𝐧 𝐩𝐡𝐢́ 𝐦𝐚𝐢 𝐦𝐨̂́𝐢\n[⚜️]→ 𝐒𝐨̂́ 𝐭𝐢𝐞̂̀𝐧 𝐧𝐚̀𝐲 𝐬𝐞̃ 𝐤𝐡𝐨̂𝐧𝐠 𝐡𝐨𝐚̀𝐧 𝐭𝐫𝐚̉ 𝐧𝐞̂́𝐮 𝟏 𝐭𝐫𝐨𝐧𝐠 𝟐 𝐧𝐠𝐮̛𝐨̛̀𝐢 𝐤𝐡𝐨̂𝐧𝐠 𝐜𝐡𝐚̂́𝐩 𝐧𝐡𝐚̣̂𝐧 𝐭𝐢𝐞̂́𝐧 𝐯𝐚̀𝐨 𝐭𝐫𝐚̣𝐧𝐠 𝐭𝐡𝐚́𝐢 𝐃𝐚𝐭𝐢𝐧𝐠 ❤️\n\n[⚜️]→ 𝐓𝐡𝐚̉ 𝐜𝐚̉𝐦 𝐱𝐮́𝐜 [❤️] 𝐯𝐚̀𝐨 𝐭𝐢𝐧 𝐧𝐡𝐚̆́𝐧 𝐧𝐚̀𝐲 𝐧𝐞̂́𝐮 𝐜𝐡𝐚̂́𝐩 𝐧𝐡𝐚̣̂𝐧 𝐭𝐢̀𝐦 𝐤𝐢𝐞̂́𝐦 𝐦𝐨̣̂𝐭 𝐧𝐠𝐮̛𝐨̛̀𝐢.`, threadID, (error, info) => {
        global.client.handleReaction.push({
            name: this.config.name,
            type: input,
            messageID: info.messageID,
...
module.exports.handleReply = async function ({ api, event, handleReply, utils, Currencies }) {
    ...
    if (type == 'house') {
        if ((!chosenIndex && chosenIndex != 0) || chosenIndex == NaN || isNaN(chosenIndex) || chosenIndex > 2 || chosenIndex < 0) return api.sendMessage("[⚜️]→ 𝐋𝐮̛̣𝐚 𝐜𝐡𝐨̣𝐧 𝐜𝐮̉𝐚 𝐛𝐚̣𝐧 𝐤𝐡𝐨̂𝐧𝐠 𝐡𝐨̛̣𝐩 𝐥𝐞̣̂.", threadID, messageID);
        ...
        if (chosenIndex == 0) {
            ...
            if ((!currentHouse && currentHouse != 0) || currentHouse < 0 || currentHouse > (Houses.length - 1)) {
                return api.sendMessage('[⚜️]→ 𝐁𝐚̣𝐧 𝐜𝐡𝐮̛𝐚 𝐜𝐨́ 𝐜𝐚̆𝐧 𝐧𝐡𝐚̀ 𝐧𝐚̀𝐨 𝐜𝐚̉.', threadID, messageID);
            } else {
            ...
            for (const house in Houses) {
                try {
                    ...
                    return api.sendMessage("[⚜️]→ Đ𝐚̃ 𝐜𝐨́ 𝐥𝐨̂̃𝐢 𝐱𝐚̉𝐲 𝐫𝐚..", threadID, () => console.log(e), messageID);
                }
            }
            var msg = {
                body: '[⚜️]→ 𝐇𝐚̃𝐲 𝐜𝐡𝐨̣𝐧 𝐜𝐡𝐨 𝐦𝐢̀𝐧𝐡 𝐦𝐨̣̂𝐭 𝐜𝐚̆𝐧 🏡\n\n𝟏. 𝟏𝟎𝟎𝟎𝟎𝟎𝟎𝟎$ (𝟓𝟎𝟎𝟎𝟎 𝐞𝐱𝐩)\n𝟐. 𝟐𝟎𝟎𝟎𝟎𝟎𝟎𝟎$ (𝟏𝟐𝟎𝟎𝟎𝟎 𝐞𝐱𝐩)\n𝟑. 𝟑𝟓𝟎𝟎𝟎𝟎𝟎𝟎$ (𝟑𝟎𝟎𝟎𝟎𝟎 𝐞𝐱𝐩)\n𝟒. 𝟔𝟎𝟎𝟎𝟎𝟎𝟎𝟎$ (𝟏𝟎𝟎𝟎𝟎𝟎𝟎 𝐞𝐱𝐩)\n\n[⚜️]→ 𝐁𝐚̣𝐧 𝐜𝐚̂̀𝐧 𝐨̛̉ 𝐦𝐨̣̂𝐭 𝐦𝐨̂́𝐜 𝐞𝐱𝐩 𝐭𝐡𝐚̂𝐧 𝐦𝐚̣̂𝐭 𝐧𝐡𝐚̂́𝐭 𝐭𝐮̛𝐨̛𝐧𝐠 𝐮̛́𝐧𝐠 𝐧𝐞̂́𝐮 𝐦𝐮𝐨̂́𝐧 𝐦𝐮𝐚 𝐧𝐡𝐚̀, 𝐬𝐞̃ 𝐤𝐡𝐨̂𝐧𝐠 𝐦𝐚̂́𝐭 𝐞𝐱𝐩 𝐤𝐡𝐢 𝐦𝐮𝐚.\n[⚜️]→ 𝐑𝐞𝐩𝐥𝐲 𝐯𝐚̀ 𝐜𝐡𝐨̣𝐧 𝐭𝐡𝐞𝐨 𝐬𝐨̂́ 𝐭𝐡𝐮̛́ 𝐭𝐮̛̣',
        ...
        if ((!chosenIndex && chosenIndex != 0) || chosenIndex == NaN || isNaN(chosenIndex) || chosenIndex > 1 || chosenIndex < 0) return api.sendMessage("[⚜️]→ 𝐋𝐮̛̣𝐚 𝐜𝐡𝐨̣𝐧 𝐜𝐮̉𝐚 𝐛𝐚̣𝐧 𝐤𝐡𝐨̂𝐧𝐠 𝐡𝐨̛̣𝐩 𝐥𝐞̣̂.", threadID, messageID);
        ...
        if (chosenIndex == 0) {
            if ((!handleReply.authorData.data.pet && handleReply.authorData.data.pet != 0) || handleReply.authorData.data.pet.length == 0) return api.sendMessage("[⚜️]→ 𝐁𝐚̣𝐧 𝐜𝐡𝐮̛𝐚 𝐜𝐨́ 𝐩𝐞𝐭 𝐧𝐚̀𝐨 𝐜𝐚̉.", threadID, messageID);
            else {
            ...
            var msg = {
                body: '[⚜️]→ 𝐇𝐚̃𝐲 𝐜𝐡𝐨̣𝐧 𝐜𝐡𝐨 𝐦𝐢̀𝐧𝐡 𝟏 𝐩𝐞𝐭\n\n𝟏. 𝐃𝐨𝐠 🐶 (𝟔𝟎𝟎 𝐄𝐱𝐩)\n𝟐. 𝐂𝐚𝐭 🐱 (𝟖𝟎𝟎 𝐄𝐱𝐩)\n𝟑. 𝐅𝐨𝐱 🦊 (𝟏𝟎𝟎𝟎 𝐄𝐱𝐩)\n𝟒. 𝐊𝐢̀ 𝐥𝐚̂𝐧 🦄 (𝟏𝟐𝟎𝟎 𝐄𝐱𝐩)\n\n[⚜️]→ 𝐑𝐞𝐩𝐥𝐲 𝐯𝐚̀ 𝐜𝐡𝐨̣𝐧 𝐭𝐡𝐞𝐨 𝐬𝐨̂́ 𝐭𝐡𝐮̛́ 𝐭𝐮̛̣',
        ...
        if ((!chosenIndex && chosenIndex != 0) || chosenIndex == NaN || isNaN(chosenIndex) || chosenIndex > (data.length - 1) || chosenIndex < 0) {
            return api.sendMessage("[⚜️]→ 𝐋𝐮̛̣𝐚 𝐜𝐡𝐨̣𝐧 𝐜𝐮̉𝐚 𝐛𝐚̣𝐧 𝐤𝐡𝐨̂𝐧𝐠 𝐡𝐨̛̣𝐩 𝐥𝐞̣̂.", threadID, messageID);
        }
        const currentHouse = handleReply.authorData.data.house;
        if (currentHouse == chosenIndex && currentHouse == data.length) {
            return api.sendMessage("[⚜️]→ 𝐁𝐚̣𝐧 𝐡𝐢𝐞̣̂𝐧 𝐬𝐨̛̉ 𝐡𝐮̛̃𝐮 𝐜𝐚̆𝐧 𝐧𝐡𝐚̀ 𝐱𝐢̣𝐧 𝐧𝐡𝐚̂́𝐭 𝐡𝐚̀𝐧𝐡 𝐭𝐢𝐧𝐡 𝐫𝐨̂̀𝐢.", threadID, messageID);
        } else if (currentHouse == chosenIndex) {
            return api.sendMessage("[⚜️]→ 𝐁𝐚̣𝐧 𝐡𝐢𝐞̣̂𝐧 𝐬𝐨̛̉ 𝐡𝐮̛̃𝐮 𝐜𝐚̆𝐧 𝐧𝐡𝐚̀ 𝐧𝐚̀𝐲 𝐫𝐨̂̀𝐢!", threadID, messageID);
        } else {
            const cost = this.houseUpgrade(currentHouse, chosenIndex);
            if (money < cost) {
                return api.sendMessage(`[⚜️]→ 𝐁𝐚̣𝐧 𝐤𝐡𝐨̂𝐧𝐠 đ𝐮̉ 𝐭𝐢𝐞̂̀𝐧 đ𝐞̂̉ 𝐦𝐮𝐚/𝐧𝐚̂𝐧𝐠 𝐜𝐚̂́𝐩 𝐧𝐡𝐚̀, 𝐛𝐚̣𝐧 𝐜𝐚̂̀𝐧 𝐭𝐡𝐞̂𝐦: ${cost - money}$`, threadID, messageID);
            } else if (handleReply.authorData.data.point < handleReply.data[`house-${chosenIndex}`].requiredExp) {
                return api.sendMessage(`[⚜️]→ 𝐁𝐚̣𝐧 𝐤𝐡𝐨̂𝐧𝐠 đ𝐮̉ 𝐞𝐱𝐩 𝐭𝐡𝐚̂𝐧 𝐦𝐚̣̂𝐭 đ𝐞̂̉ 𝐦𝐮𝐚, 𝐛𝐚̣𝐧 𝐜𝐚̂̀𝐧 𝐭𝐡𝐞̂𝐦 ${handleReply.data[`house-${chosenIndex}`].requiredExp - handleReply.authorData.data.point} 𝐞𝐱𝐩`, threadID, messageID);
            } else {
        ...
        if (currentPet.some(e => e.id == chosenIndex)) {
            return api.sendMessage("[⚜️]→ 𝐁𝐚̣𝐧 𝐡𝐢𝐞̣̂𝐧 𝐬𝐨̛̉ 𝐡𝐮̛̃𝐮 𝐩𝐞𝐭 𝐧𝐚̀𝐲 𝐫𝐨̂̀𝐢!", threadID, messageID);
        } else if (currentExp < chosenPet.expCost) {
            return api.sendMessage(`[⚜️]→ 𝐁𝐚̣𝐧 𝐤𝐡𝐨̂𝐧𝐠 đ𝐮̉ 𝐞𝐱𝐩 𝐭𝐡𝐚̂𝐧 𝐦𝐚̣̂𝐭 đ𝐞̂̉ 𝐦𝐮𝐚, 𝐛𝐚̣𝐧 𝐜𝐚̂̀𝐧 𝐭𝐡𝐞̂𝐦 ${chosenPet.expCost - currentExp} 𝐞𝐱𝐩`, threadID, messageID);
        } else {
            currentPet.push({
                id: chosenIndex,
            ...
            return api.sendMessage({
                body: `[⚜️]→ 𝐌𝐮𝐚 𝐭𝐡𝐚̀𝐧𝐡 𝐜𝐨̂𝐧𝐠!\n[⚜️]→ 𝐓𝐮̛̀ 𝐠𝐢𝐨̛̀ 𝐦𝐨̣𝐢 𝐄𝐱𝐩 𝐭𝐡𝐚̂𝐧 𝐦𝐚̣̂𝐭 𝐧𝐡𝐚̣̂𝐧 𝐯𝐚̀𝐨 đ𝐞̂̀𝐮 đ𝐮̛𝐨̛̣𝐜 𝐭𝐚̆𝐧𝐠 𝐭𝐡𝐞̂𝐦: ${this.getPetBonus(currentPet) * 100}%`,
                attachment: petImage
            }, threadID, messageID);
        }
    }
        ...
        if (!chosenIndex || chosenIndex == NaN || isNaN(chosenIndex) || chosenIndex > handleReply.authorPoint || chosenIndex < 0) {
            return api.sendMessage("[⚜️]→ 𝐒𝐨̂́ 𝐩𝐨𝐢𝐧𝐭 𝐛𝐚̣𝐧 𝐧𝐡𝐚̣̂𝐩 𝐤𝐡𝐨̂𝐧𝐠 𝐡𝐨̛̣𝐩 𝐥𝐞̣̂.", threadID, messageID);
        } else {
            api.unsendMessage(handleReply.messageID);
            return api.sendMessage(`[⚜️]→ 𝐁𝐚̣𝐧 𝐬𝐞̃ 𝐝𝐮̀𝐧𝐠 ${chosenIndex} 𝐞𝐱𝐩 𝐯𝐚̀ 𝐧𝐡𝐚̣̂𝐧 𝐥𝐚̣𝐢 ${chosenIndex * 20}$\n𝐓𝐡𝐚̉ 𝐜𝐚̉𝐦 𝐱𝐮́𝐜 [😁] 𝐭𝐢𝐧 𝐧𝐡𝐚̆́𝐧 𝐧𝐚̀𝐲 𝐧𝐞̂́𝐮 𝐜𝐡𝐚̂́𝐩 𝐧𝐡𝐚̣̂𝐧`, threadID, (err, info) => {
                if (err) return console.log(err);
                global.client.handleReaction.push({
                    name: this.config.name,
                    messageID: info.messageID,
        ...
        if (money < handleReply.shop[parseInt(body) - 1].money) return api.sendMessage(`[⚜️]→ 𝑩𝒂̣𝒏 𝒌𝒉𝒐̂𝒏𝒈 đ𝒖̉ ${handleReply.shop[parseInt(body) - 1].money} đ𝒆̂̉ 𝒎𝒖𝒂 𝒗𝒂̣̂𝒕 𝒑𝒉𝒂̂̉𝒎`, threadID, messageID);
        ...
        writeFileSync(path, JSON.stringify(dataDating, null, 4));
        api.unsendMessage(handleReply.messageID);
        return api.sendMessage(`[⚜️]→ 𝐌𝐮𝐚 𝐭𝐡𝐚̀𝐧𝐡 𝐜𝐨̂𝐧𝐠 𝐯𝐚̀ 𝐭𝐚̣̆𝐧𝐠 𝐪𝐮𝐚̀ 𝐜𝐡𝐨 𝐧𝐠𝐮̛𝐨̛̀𝐢 𝐲𝐞̂𝐮 𝐜𝐮̉𝐚 𝐛𝐚̣𝐧 𝐭𝐡𝐚̀𝐧𝐡 𝐜𝐨̂𝐧𝐠\n𝐄𝐱𝐩 𝐭𝐡𝐚̂𝐧 𝐦𝐚̣̂𝐭 𝐜𝐮̉𝐚 𝐛𝐚̣𝐧 𝐯𝐚̀ 𝐧𝐲 𝐭𝐚̆𝐧𝐠 ${pointToIncrease} (+${Math.floor(pointToIncrease * bonusPercent)}), 𝐭𝐨̂̉𝐧𝐠: ${handleReply.data.data.point}`, threadID, () => {
            if (isHungry == true) api.sendMessage(`[⚜️]→ 𝐂𝐨́ 𝐯𝐞̉ 𝐩𝐞𝐭 𝐜𝐮̉𝐚 𝐛𝐚̣𝐧 𝐜𝐚̂̀𝐧 𝐜𝐡𝐨 𝐚̆𝐧, 𝐧𝐞̂́𝐮 𝐤𝐡𝐨̂𝐧𝐠 𝐜𝐡𝐨 𝐩𝐞𝐭 𝐚̆𝐧 𝐪𝐮𝐚́ 𝐦𝐨̣̂𝐭 𝐧𝐠𝐚̀𝐲 𝐛𝐚̣𝐧 𝐬𝐞̃ 𝐦𝐚̂́𝐭 𝐩𝐞𝐭`, threadID);
        })
    }
}
    ...
    switch (type) {
        ...
        case '6': {
            ...
            if (data.accept_one && data.accept_two) {
                ...
                writeFileSync(path, JSON.stringify(dataDating, null, 4));
                return api.sendMessage(`[⚜️]→ 𝐃𝐢𝐞𝐦𝐝𝐚𝐧𝐡 𝐭𝐡𝐚̀𝐧𝐡 𝐜𝐨̂𝐧𝐠! 𝐄𝐱𝐩 𝐭𝐡𝐚̂𝐧 𝐦𝐚̣̂𝐭 𝐜𝐮̉𝐚 𝐛𝐚̣𝐧 𝐛𝐚̣𝐧 𝐭𝐚̆𝐧𝐠 𝐭𝐡𝐞̂𝐦 ${pointToIncrease}, 𝐭𝐨̂̉𝐧𝐠: ${author.data.point}`, threadID, () => {
                    if (isHungry == true) api.sendMessage(`[⚜️]→ 𝐂𝐨́ 𝐯𝐞̉ 𝐩𝐞𝐭 𝐜𝐮̉𝐚 𝐛𝐚̣𝐧 𝐜𝐚̂̀𝐧 𝐜𝐡𝐨 𝐚̆𝐧, 𝐧𝐞̂́𝐮 𝐤𝐡𝐨̂𝐧𝐠 𝐜𝐡𝐨 𝐩𝐞𝐭 𝐚̆𝐧 𝐪𝐮𝐚́ 𝐦𝐨̣̂𝐭 𝐧𝐠𝐚̀𝐲 𝐛𝐚̣𝐧 𝐬𝐞̃ 𝐦𝐚̂́𝐭 𝐩𝐞𝐭`, threadID);
                });
            }
        }
        case '9': {
            if (reaction != '😁') return;
                ...
                writeFileSync(path, JSON.stringify(dataDating, null, 4));
                return api.sendMessage(`[⚜️]→ 𝐁𝐚́𝐧 𝐭𝐡𝐚̀𝐧𝐡 𝐜𝐨̂𝐧𝐠 𝐯𝐚̀ 𝐧𝐡𝐚̣̂𝐧 𝐯𝐞̂̀ ${houseCost} 𝐕𝐍𝐃`, threadID);
            }
            break;
        }
        case '10': {
            if (reaction != '😁' || moneyForFeed === 0) return;
                ...
                dataDating[dataDating.findIndex(i => i.ID_one == senderID || i.ID_two == senderID)].data.petLastFeed = Date.now();
                writeFileSync(path, JSON.stringify(dataDating, null, 4));
                return api.sendMessage(`[⚜️]→ 𝐁𝐚̣𝐧 𝐯𝐮̛̀𝐚 𝐜𝐡𝐨 𝐩𝐞𝐭 𝐚̆𝐧 𝐭𝐡𝐚̀𝐧𝐡 𝐜𝐨̂𝐧𝐠 😻`, threadID);
            }
            break;
        }
        case '11': {
            if (reaction != '😁') return;
                ...
                api.unsendMessage(handleReaction.messageID);
                if (authorPoint < chosenPoint) return api.sendMessage("[⚜️]→ 𝐁𝐚̣𝐧 𝐤𝐡𝐨̂𝐧𝐠 đ𝐮̉ 𝐞𝐱𝐩 đ𝐞̂̉ đ𝐨̂̉𝐢!", threadID);
                ...
                writeFileSync(path, JSON.stringify(dataDating, null, 4));
                return api.sendMessage(`[⚜️]→ 𝐁𝐚̣𝐧 đ𝐚̃ đ𝐨̂̉𝐢 𝐭𝐡𝐚̀𝐧𝐡 𝐜𝐨̂𝐧𝐠 ${chosenPoint} 𝐞𝐱𝐩 𝐯𝐚̀ 𝐧𝐡𝐚̣̂𝐧 ${chosenPoint * 20}$`, threadID);
            }
        }
        default:
            break;
