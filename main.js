//////////////////////////////////////////////////////
//========= Require all variable need use =========//408
/////////////////////////////////////////////////////
...
global.client.api = loginApiData;
 ...
 logger.loader(`Thời gian khởi động: ${(Date.now() - global.client.timeStart) / 100}s`);
        logger('CÓ HÀNH VI THAY ĐỔI SOURCE CODE THÌ HÃY TỪ BỎ', '𝓓𝓻𝓪𝓰𝓸𝓷');
        logger("CHÚC ANH EM CÓ MỘT NGÀY TỐT LÀNH", '𝓓𝓻𝓪𝓰𝓸𝓷');
...
console.log(color('[ CLIENT ]', 'cyan'), color('𝓑𝓸𝓽 𝓓𝓻𝓪𝓰𝓸𝓷 successfully activated!! ', 'yellow'));
